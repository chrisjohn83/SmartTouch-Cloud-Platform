...
import {
  ...
  require_undici,
  shouldBypassProxy
} from "./chunks/FDUPOI4C.js";
import {
  ANONYMOUS_ID_CACHE_FILE,
  DEFAULT_FETCH_TIMEOUT,
  OTEL_URL
} from "./chunks/Y6DTFCLS.js";
import "./chunks/EIHBO33S.js";
import {
  engines,
  name,
  version
} from "./chunks/FP2VGYMF.js";
import {
  RESET_ESCAPE_CODE,
  calculateTotals,
  conditionallyMaskSecrets
} from "./chunks/GRMVFQAA.js";
...
async function handleGenerateArazzo({
  ...
  try {
    const { generate } = await import("./chunks/4DNBVE5S.js");
...
async function handleRespect({
  ...
  let harLogs;
  try {
    const { run, conditionallyMaskSecrets: conditionallyMaskSecrets2 } = await import("./chunks/4DNBVE5S.js");
...
async function sendTelemetry({
  ...
  try {
    ...
    const { RedoclyOAuthClient: RedoclyOAuthClient2 } = await import("./chunks/YA5P3RI2.js");
    ...
    const eventData = [
      {
        ...
        spec_keyword,
        spec_full_version,
        respect_x_security_auth_types: spec_version === "arazzo1" && respect_x_security_auth_types?.length ? JSON.stringify(respect_x_security_auth_types) : void 0,
        respect_source_description_types: spec_version === "arazzo1" && respect_source_description_types?.length ? JSON.stringify(respect_source_description_types) : void 0,
        respect_criterion_object_types: spec_version === "arazzo1" && respect_criterion_object_types?.length ? JSON.stringify(respect_criterion_object_types) : void 0
      }
    ];
    ...
    const { otelTelemetry } = await import("./chunks/2ULY6UWW.js");
...
yargs_default(hideBin(process.argv)).version("version", "Show version number.", version).help("help", "Show help.").parserConfiguration({ "greedy-arrays": false, "boolean-negation": false }).command(
  ...
  async (argv) => {
    const { handlerBuildCommand } = await import("./chunks/7GOGGHM5.js");
