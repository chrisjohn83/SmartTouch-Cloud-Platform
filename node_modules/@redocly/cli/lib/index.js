...
yargs(hideBin(process.argv))
    ...
    .command('score [api]', 'Score an API description for integration simplicity and agent readiness.', (yargs) => yargs
    ...
    .command('scorecard-classic [api]', 'Run quality scorecards with multiple rule levels to validate and maintain API description standards.', (yargs) => {
