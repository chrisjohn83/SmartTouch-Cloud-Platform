 ...
 */
export declare const upsertScope: (store: WorkspaceStore | null, document: WorkspaceDocument | null, { name, flowType, scope, description, oldScope, enable }: AuthEvents["auth:upsert:scopes"]) => void;
/**
 * Removes a scope from an OAuth flow and strips it from any selection state that references
 * the matching security scheme.
 */
export declare const deleteScope: (store: WorkspaceStore | null, document: WorkspaceDocument | null, { name, flowType, scope }: AuthEvents["auth:delete:scopes"]) => void;
/**
...
export declare const authMutatorsFactory: ({ document, store, }: {
    ...
    upsertScope: (payload: AuthEvents["auth:upsert:scopes"]) => void;
    deleteScope: (payload: AuthEvents["auth:delete:scopes"]) => void;
