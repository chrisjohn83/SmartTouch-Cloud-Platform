...
var _hoisted_8 = { class: "client-libraries-text" };
var _hoisted_9 = { class: "client-libraries" };
		...
		*/
		...
		return (_ctx, _cache) => {
			return sdks.value.length ? (openBlock(), createElementBlock("div", _hoisted_1, [
				...
				createElementVNode("div", _hoisted_3, [createElementVNode("div", {
				...
				}), 128)), visibleCount.value < sdks.value.length ? (openBlock(), createBlock(unref(ScalarCombobox), {
					key: 0,
					...
					}, null, 8, ["icon"]), _cache[0] || (_cache[0] = createElementVNode("span", { class: "client-libraries-text" }, "More", -1))], 2)]),
					_: 1
				}, 8, ["modelValue", "options"])) : createCommentVNode("", true)], 8, _hoisted_4), createElementVNode("div", _hoisted_7, [createElementVNode("div", {
					ref_key: "measureRef",
					ref: measureRef,
					...
					return openBlock(), createElementBlock("span", {
						...
						class: "client-libraries-icon",
						icon: sdk.icon
					}, null, 8, ["icon"])) : createCommentVNode("", true), createElementVNode("span", _hoisted_8, toDisplayString(sdk.lang), 1)]);
				}), 128)), createElementVNode("span", _hoisted_9, [createVNode(unref(ScalarIcon), {
					class: "client-libraries-icon",
					icon: "Ellipses"
				}), _cache[1] || (_cache[1] = createElementVNode("span", { class: "client-libraries-text" }, "More", -1))])], 512)])]),
				selected.value?.description ? (openBlock(), createElementBlock("div", {
					...
					role: "tabpanel",
					tabindex: "0"
				}, [createVNode(unref(ScalarMarkdown), { value: selected.value.description }, null, 8, ["value"])], 8, _hoisted_10)) : createCommentVNode("", true)
